...
export default function HoverInfo({ title, children, align = "left" }) {
    return (
        <div className="hover-info relative inline-flex items-center group">
            ...
            <div
                className={`hover-info-panel absolute top-7 hidden group-hover:block w-[28rem] max-w-[90vw] rounded-[1.25rem] border border-slate-200 dark:border-slate-700 bg-white/95 dark:bg-slate-900/95 p-4 shadow-2xl text-left backdrop-blur ${align === "right" ? "right-0" : "left-0"
                    }`}
            >
